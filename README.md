...
本项目是一个AI编程练手项目，灵感来自于[https://github.com/datawhalechina/hello-agents](https://github.com/datawhalechina/hello-agents)，本项目所使用的文字、音频、视频素材均有人工智能辅助。

本项目为免费项目，任何人都可以免费游玩此游戏，并欢迎提出改进建议。

任何不正当贩卖此项目相关游戏本体、素材的行为都是不妥当的。
